...
export const Settings: React.FC = () => {
  const defaultMessage = 'O sistema está em manutenção até as 02:00.';
          ...
          <div className="flex items-center justify-between">
            <div className="pr-4">
              ...
              <p className={`text-sm mt-1 ${maintenance.isActive ? 'text-orange-700' : 'text-slate-500'}`}>
                {maintenance.isActive 
                  ? 'ATIVO: O gateway estáeitando novas conexes.' 
                  : 'INATIVO: O sistema estáraçãormalmente.'}
              </p>
            </div>
                ...
                <div className="grid gap-5 p-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
                  <div className="rounded-2xl border border-orange-100 bg-white/90 p-5 shadow-sm">
                    ...
                    <p className="mb-4 text-sm text-slate-500">
                      Este texto aparece para integraes e acessos bloqueados enquanto a manuteno estáhabilitada.
                    </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sky-800/80">
                            Alterar estátus afeta imediatamente os endpoints pblicos do gateway e os acessos sem exceo configurada.
                          </p>
                        </div>
                      </div>
                    </div>
