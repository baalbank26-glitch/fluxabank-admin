              ...
              <div className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex gap-2">
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-slate-100 text-slate-300 border border-emerald-500/20 uppercase">
                ...
                <div className="flex items-center gap-2 w-full md:w-auto mt-4 md:mt-0">
                  <button 
                    ...
                    className="px-3 py-2 text-slate-300 border border-slate-300 rounded-lg text-sm font-medium hover:bg-[#090d0a] flex items-center justify-center gap-2 transition-colors"
                  >
