    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <button
                    onClick={() => fetchLogs()}
                    className="p-2 hover:bg-emerald-950/40 rounded-full transition-colors"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-[#0f1713] p-4 rounded-xl border border-emerald-500/20 shadow-sm flex items-center gap-4">
                    <div className="p-3 bg-emerald-950/20 rounded-lg">
                        <AlertTriangle className="w-6 h-6 text-emerald-500" />
                    </div>
                    <div>
                        <p className="text-xs font-medium text-slate-400 uppercase">Total de Alertas</p>
                ...
                <div className="bg-[#0f1713] p-4 rounded-xl border border-emerald-500/20 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs font-medium text-slate-400 uppercase">IPs Bloqueados (24h)</p>
                        <p className="text-2xl font-bold text-slate-100">
            ...
            {/* Filtros */}
            <form onSubmit={handleFilterSubmit} className="bg-[#0f1713] p-4 rounded-xl border border-emerald-500/20 shadow-sm grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-[#0c1410] border-b border-emerald-500/20">
                                ...
                                <th className="px-6 py-4 text-xs font-bold text-slate-400 uppercase">Caminho</th>
                                <th className="px-6 py-4 text-xs font-bold text-slate-400 uppercase">Motivo</th>
                                <th className="px-6 py-4 text-xs font-bold text-slate-400 uppercase text-center">Ação</th>
                            </tr>
                        </thead>
                                    ...
                                    <tr key={log.id} className="hover:bg-[#0c1410] transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-sm text-slate-300 font-mono truncate max-w-[200px]" title={log.path}>
                                                    {log.path}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <p className="text-sm text-slate-300 line-clamp-2 max-w-[250px]" title={log.reason}>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <button
                                                ...
                                                className="p-2 text-slate-400 hover:text-emerald-500 hover:bg-emerald-950/20 rounded-lg transition-all"
                                                title="Ver detalhes"
                                            >
                        ...
                        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="bg-[#0c1410] rounded-2xl p-4 space-y-3">
                                        ...
                                        <div className="flex justify-between items-center py-2 border-b border-emerald-500/20">
                                            <span className="text-sm text-slate-400">IP de Origem</span>
                                            <span className="text-sm font-bold text-emerald-500 font-mono">{selectedLog.ip_address}</span>
                                        </div>
                                        <div className="flex justify-between items-center py-2 border-b border-emerald-500/20">
                                            <span className="text-sm text-slate-400">Método HTTP</span>
                                            <span className="text-sm font-bold text-slate-100 bg-slate-200 px-2 py-0.5 rounded uppercase">{selectedLog.method}</span>
                                        </div>
                                        <div className="flex flex-col py-2">
                                            <span className="text-sm text-slate-400 mb-1">Caminho do Recurso</span>
                                            <span className="text-sm font-mono text-slate-200 bg-[#0f1713] p-2 rounded border border-emerald-500/20 break-all">{selectedLog.path}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="bg-emerald-950/20 border border-emerald-950/40 rounded-2xl p-4">
